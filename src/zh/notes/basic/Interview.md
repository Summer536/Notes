...
可以看[Deepseek_MLA.md](https://summer536.github.io/Notes/zh/notes/ai-infra/Deepseek_MLA.html)的1.3节对kv cache的显存占用计算进行了分析。
...
详细见[Deepseek_MLA.md](https://summer536.github.io/Notes/zh/notes/ai-infra/Deepseek_MLA.html)的2.4小节
...
2. 大模型的weight并不是每一行每一列重要性都是一样的，需要**甄选出重要的weight**，其它不重要的，可以量化为更低的精度(int3/int4)，参考[AWQ](https://summer536.github.io/Notes/zh/notes/ai-infra/AWQ.html)
